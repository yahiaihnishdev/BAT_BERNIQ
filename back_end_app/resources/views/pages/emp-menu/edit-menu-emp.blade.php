<ul class="nav nav-tabs" id="employeeTabs" role="tablist">
    <li class="nav-item" role="presentation">
        <a href="../employee/edit-employee.php?emp_id=<?php echo $emp_id; ?>" class="nav-link link-dark">
    ...
    <li class="nav-item" role="presentation">
        <a href="../emp-family/family-index.php" class="nav-link link-dark">
    ...
    <li class="nav-item" role="presentation">
        <a href="../emp-emergency/emergency-index.php" class="nav-link link-dark">
