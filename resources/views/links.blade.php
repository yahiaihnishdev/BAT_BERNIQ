<div class="sidebar d-flex flex-column flex-shrink-0 p-3 bg-light" ">
    ...
    <ul class="nav nav-pills flex-column mb-auto">
            <li class="nav-item">
                <a href="#" class="nav-link link-dark" data-link="admin" aria-current="page">
            ...
            <li class="nav-item">
                <a href="#" class="nav-link link-dark" data-link="jobs-index">
                    <i class="bi bi-calendar-check"></i>
                    <span>الوظائف</span>
                </a>
            </li>
            <li class="nav-item">
                <a href="" class="nav-link link-dark" data-link="department-index">
